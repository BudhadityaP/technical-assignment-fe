...
const winner = ({ winner, userPoints, computerPoints, page }) => {
    ...
    return (
    <div>
        <Confetti confettiSource={winner === 'p1' ? { x: 0, y: 0,h:0 } : { x: window.innerWidth, y: 0, h:0  }}></Confetti>
        <Row area-label='winner section' style={{ ...styles.SectionContainer, backgroundColor: '#DCFBBA' }}>
